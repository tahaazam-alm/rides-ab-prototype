...
const dict = {
  en: {
    ...
    'rides.car.business-sedan.name': 'Business Sedan',
    'rides.car.business-sedan.model': 'Mercedes E-Class or similar',
    'rides.car.luxury-sedan.name': 'Luxury Sedan',
    'rides.car.luxury-sedan.model': 'Tesla model Y or similar',
    'rides.car.economy-suv.name': 'Economy SUV',
    'rides.car.economy-suv.model': 'Toyota Land Cruiser or similar',
    'rides.car.luxury-suv.name': 'Luxury SUV',
    'rides.car.luxury-suv.model': 'GMC Yukon XL or similar',
    'rides.car.mini-van.name': 'Mini Van',
    'rides.car.mini-van.model': 'Toyota Hiace or similar',
    'rides.car.economy-van.name': 'Economy Van',
    'rides.car.economy-van.model': 'Hyundai H1 or similar',
    'rides.car.premium-van.name': 'Premium Van',
    'rides.car.premium-van.model': 'Mercedes V-Class or similar',
  ...
  ar: {
    ...
    'rides.car.business-sedan.name': 'سيدان أعمال',
    'rides.car.business-sedan.model': 'مرسيدس E-Class أو مماثل',
    'rides.car.luxury-sedan.name': 'سيدان فاخرة',
    'rides.car.luxury-sedan.model': 'تسلا موديل Y أو مماثل',
    'rides.car.economy-suv.name': 'إس يو في اقتصادية',
    'rides.car.economy-suv.model': 'تويوتا لاند كروزر أو مماثل',
    'rides.car.luxury-suv.name': 'إس يو في فاخرة',
    'rides.car.luxury-suv.model': 'جي إم سي يوكن XL أو مماثل',
    'rides.car.mini-van.name': 'ميني فان',
    'rides.car.mini-van.model': 'تويوتا هايس أو مماثل',
    'rides.car.economy-van.name': 'فان اقتصادي',
    'rides.car.economy-van.model': 'هيونداي H1 أو مماثل',
    'rides.car.premium-van.name': 'فان بريميوم',
    'rides.car.premium-van.model': 'مرسيدس V-Class أو مماثل',
